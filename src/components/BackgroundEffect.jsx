...
export default function AnimatedBackground() {
    useEffect(() => {
        ...
        background.style.background =
            "radial-gradient(at 50% 50%, #0f172a, #1e293b, #334155)";
        ...
        style.textContent = `
            ...
            @keyframes pulse {
                0%, 100% { opacity: 0.7; filter: blur(${isMobile ? "15px" : "30px"
            }) brightness(1); }
                50% { opacity: 0.9; filter: blur(${isMobile ? "15px" : "30px"
            }) brightness(1.2); }
            }
        `;
    ...
    const allPositions = [
        {
            ...
            animation: `slowRotate ${isMobile ? "10s" : "5s"
                } ease-in-out infinite, pulse ${isMobile ? "12s" : "8s"
        ...
        },
        {
            ...
            animation: `slowRotate ${isMobile ? "15s" : "9s"
                } ease-in-out infinite reverse, pulse ${isMobile ? "15s" : "10s"
                } ease-in-out infinite`,
        },
        {
            bottom: "5%",
            ...
            animation: `slowRotate ${isMobile ? "18s" : "12s"
        ...
        },
        {
            ...
            right: "5%",
            width: isMobile ? "80%" : "60%",
            animation: `slowRotate ${isMobile ? "20s" : "15s"
                } ease-in-out infinite alternate-reverse, pulse ${isMobile ? "15s" : "12s"
                } ease-in-out infinite`,
        },
    ];
