export default function ProjectCard({ title, description, imageUrl, projectUrl, tags, detailsUrl }) {
    return (
        <div className="bg-gray-900/70 rounded-lg overflow-hidden shadow-lg transition-all hover:scale-[1.02] hover:shadow-xl group relative font-sans z-10 h-full flex flex-col mx-auto">
