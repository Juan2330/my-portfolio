            ...
            <section id="contact" className="py-14 px-4 sm:px-6 bg-gray-800">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="flex items-center bg-gray-900 p-6 rounded-lg hover:bg-gray-800 transition">
                        <div className="w-16 h-16 flex items-center justify-center bg-blue-500/20 rounded-full mr-6">
                    ...
                    <div className="flex items-center bg-gray-900 p-6 rounded-lg hover:bg-gray-800 transition">
                        <div className="w-16 h-16 flex items-center justify-center bg-blue-500/20 rounded-full mr-6">
                        <FontAwesomeIcon icon={faWhatsapp} className="text-blue-400 text-2xl" />
                        </div>
                        <div>
