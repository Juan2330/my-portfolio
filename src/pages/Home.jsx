...
export default function Home() {
    ...
    const createCloudinaryUrl = (publicId, width, height) => {
        return `https://res.cloudinary.com/dy1t4y5wc/image/upload/c_fill,f_auto,w_${width},h_${height}/${publicId}`;
    };
        ...
        <main className="min-h-screen bg-gray-900 text-white">
            <section id="hero" className="py-20 px-6">
                <div className="container mx-auto text-center">
                    <h1 className="text-4xl md:text-6xl font-bold mb-6">Hola, soy <span className="text-blue-400">Jacobo Ramírez</span></h1>
            ...
            <section id="about" className="py-16 px-6">
                <div className="container mx-auto max-w-4xl">
                    ...
                    <div className="bg-gray-800 p-8 rounded-lg">
                        ...
                        <h3 className="text-xl font-semibold mt-6 mb-4">Habilidades Técnicas:</h3>
                        <ul className="grid grid-cols-2 md:grid-cols-3 gap-2">
                            {['JavaScript', 'React', 'Preact', 'Node.js', 'TailwindCSS', 'Git', 'SQL', 'Python', 'AI Integration'].map((skill, i) => (
                                <li key={i} className="bg-gray-700 px-4 py-2 rounded">{skill}</li>
                            ))}
                        </ul>
                    </div>
                </div>
            ...
            <section id="contact" className="py-16 px-6 bg-gray-800">
                <div className="container mx-auto max-w-4xl">
                    ...
                    <div className="bg-gray-900 p-8 rounded-lg grid grid-cols-1 md:grid-cols-3 gap-6">
                        
                        {/* Correo */}
                        <div className="text-center">
                            <div className="p-4 inline-block mb-4 bg-blue-500/20 rounded-full">
                        ...
                        {/* WhatsApp */}
                        <div className="text-center">
                            <div className="w-20 h-20 flex items-center justify-center mb-6 bg-blue-500/20 rounded-full mx-auto">
                                <FontAwesomeIcon 
                                    icon={faWhatsapp} 
